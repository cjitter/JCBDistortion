...
public:
    ...
    // Control para mostrar contenido vacío (para distorsionador)
    void setContentVisible(bool visible) noexcept { contentVisible = visible; repaint(); }
...
private:
    ...
    float ceiling = 0.0f;              // Techo máximo por defecto en dB (e_CEILING)
